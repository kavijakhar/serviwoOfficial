      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex flex-col">
          <div className="lg:w-4/6 mx-auto">
            <div className="rounded-lg sm:mx-0 mx-3  overflow-hidden" style={{ 'height': '300px' }}>
            ...
            <div className="flex flex-col sm:flex-row mt-10">
              <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                ...
                <div className="flex flex-col">
                  <h2 className="font-medium title-font mt-4 text-gray-900 text-lg">{blog.authorName}</h2>
                  <h2 className="font-medium title-font mt-4 text-gray-900 text-lg">{formattedDate}</h2>
              ...
              <div className=''>
                <div className=" sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                  <h1 className="leading-relaxed text-4xl mb-4">{blog.title}</h1>

                </div>
                <div className=" sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                  <h3 className="leading-relaxed text-xl mb-4">{blog.description}</h3>
