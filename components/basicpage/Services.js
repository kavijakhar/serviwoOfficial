...
const Services = () => {
  return (
    <div id="services" className="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-white max-md:mx-20">
      <div className="container xl:max-w-6xl mx-auto px-4">
        {/* Heading start */}
        <header className="text-center mx-auto mb-12 lg:px-20">
          <h2 className="text-2xl leading-normal mb-2 font-bold text-black heading">What We Do</h2>
          <svg
            version="1.1"
          ...
          Empower Your Brand&#39;s Potential: Unleash the Power of Creativity, Technology, and Strategy. Let Us Handle Your Graphic Designs, Website Designs, SEO, Website Development, and Engaging Social Content. Elevate Your Brand&#39;s Identity and Accelerate Your Success Today!
          </p>
        </header>
        {/* End heading */}
        {/* row */}
        <div className="flex flex-wrap flex-row -mx-4 text-center">
          {/* Replaceable service blocks */}
          {/* You can add or modify these service blocks */}
          <ServiceBlock
           icon={RiSeoFill}
        ...
        icon={SiXdadevelopers}
          ...
          />
          {/* End replaceable service blocks */}
        </div>
        {/* end row */}
      </div>
    </div>
...
const ServiceBlock = ({ icon, title, description }) => {
  ...
  return (
    <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp " data-wow-duration="1s" style={{ visibility: 'visible', animationDuration: '1s', animationName: 'fadeInUp' }}>
      <div className="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2 shadow-lg">
