        ...
        <>
            ...
            <div class={`min-h-screen md:mx-20  mx-7 flex flex-wrap items-center text-xl justify-center  mt-28 ${animate ? 'opacity-100 -translate-y-[60px]' : 'opacity-0'}`} id="pricing">
                ...
                <div class="flex flex-col sm:flex-col lg:flex-row xl:flex-row md:flex-row justify-center items-center container mx-auto">
                    ...
                    <div class="py-12 hover:scale-110 md:m-12 h-[full] sm:py-12 md:py-6 lg:py-6 xl:py-6 px-8 w-full md:max-w-[350px] sm:w-full bg-purple-500 transform scale-1 sm:scale-1 md:scale-105 lg:scale-105 xl:scale-105 z-40  mt-5 md:mt-0 md:shadow-xl lg:shadow-xl xl:shadow-xl text-white">
                    ...
                    <div class="py-12  hover:scale-105 shadow-md mt-5 md:mt-0 h-[full] sm:py-12 md:py-6 lg:py-6 xl:py-6 px-8 w-full md:max-w-[350px] sm:w-full bg-white z-30">
